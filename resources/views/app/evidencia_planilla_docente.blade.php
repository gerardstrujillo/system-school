...
<body>
  ...
  <div class="container py-4">
    <h3 class="mb-4">Subir Evidencia de Planilla de Notas</h3>
    ...
    <form action="{{ route('profesor.subir-evidencia') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="mb-3">
      ...
      <h5>Seleccione la evidencia para cada materia</h5>
      @foreach($materias as $materia)
        <div class="mb-3">
          <label class="form-label">{{ $materia->nombre_materia }}</label>
          <input type="file" name="evidencias[{{ $materia->id_materia }}]" class="form-control"
                 accept=".pdf,image/*">
          <small class="text-muted">Formato permitido: PDF o imagen.</small>
        </div>
      @endforeach
